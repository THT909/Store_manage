...
export class AdditionalCostsController {
  constructor(private readonly additionalCostsService: AdditionalCostsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateAdditionalCostDto: UpdateAdditionalCostDto) {
